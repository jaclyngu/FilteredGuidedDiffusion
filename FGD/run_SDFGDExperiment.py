...
invert_portion=1.
output_dirname='../outputs_param_search_FGD_X0_seed10_alphaisback'#_DDIMInvert'+str(invert_portion)/video_results/bear/
#dataset dir
...
normalize_guidances=[0, 1, 3]
d_structures=[10, 15, 20]#0.05, 0.2, 
use_xT = True
use_FGD = True
plms = True
SDEdit_strengths = [-1]
...
#     if f not in ['hamburger', 'monalisa']: #f!='pnp_sand_car':
#         continue
